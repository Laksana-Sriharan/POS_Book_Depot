    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label for="amount" class="form-label">Paid Amount </label>
             <p class="text-danger"> Rs . {{ $order->pay }} </p>
        </div>
    </div>
 ...
 <div class="col-md-6">
        <div class="mb-3">
            <label for="due" class="form-label">Due Amount </label>
             <p class="text-danger"> Rs . {{ $order->due }} </p>
        </div>
    </div>
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-success waves-effect waves-light mt-2"><i class="fa-regular fa-circle-check"></i> &nbsp; Complete Order </button>
            </div>
        </form>
    </div><br>
