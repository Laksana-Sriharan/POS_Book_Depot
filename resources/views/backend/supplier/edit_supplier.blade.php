                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a  class="btn btn-primary rounded-pill waves-effect waves-light text-light" href="{{ route('all.supplier') }}"><i class="fa-solid fa-angle-left"></i> &nbsp; Back </a></li>
                                        </ol>
                                    </div>
  ...
  <div class="col-md-6">
        <div class="mb-3">
           ...
           <select name="type" class="form-select @error('type') is-invalid @enderror" id="example-select">
                    ...
                    <option value="Exporters" {{ $supplier->type == 'Exporters' ? 'selected' : '' }}>Exporters </option>
                    <option value="Local Suppliers" {{ $supplier->type == 'Local Suppliers' ? 'selected' : '' }}>Local Suppliers </option> 
                </select>
                 @error('type')
      <span class="text-danger"> {{ $message }} </span>
            @enderror
