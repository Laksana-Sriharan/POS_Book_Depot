                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a  class="btn btn-primary rounded-pill waves-effect waves-light text-light" href="{{ route('all.permission') }}"><i class="fa-solid fa-angle-left"></i> &nbsp; Back </a></li>
...
<div class="card">
    ...
    <div class="col-md-6">
        ...
        <option value="roles"> Roles</option> 
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-success waves-effect waves-light mt-2"><i class="fa-solid fa-hand-holding-hand"></i> &nbsp; Grant Permission </button>
            </div>
        </form>
    </div>
