...
@section('admin')
    ...
    <div class="bg-secondary">
        ...
        <p style="font-size:18px; color:#fff"> SubTotal : Rs . {{ Cart::subtotal() }} </p>
        <p style="font-size:18px; color:#fff"> Tax : Rs . {{ Cart::tax() }} </p>
        <p><h2 class="text-white"> Total </h2> <h1 class="text-white"> Rs . {{ Cart::total() }}</h1>   </p>
         <br>
    </div>
 ...
 <br>
    <form id="myForm" method="post" action="{{ url('/create-invoice') }}">
        ...
        <div class="form-group mb-3">
            <label for="firstname" class="form-label">All Customers </label> &nbsp; &nbsp; &nbsp;

              <a href="{{ route('add.customer') }}" class="btn btn-info rounded-pill waves-effect waves-light mb-2"><i class="fa-solid fa-plus"></i> &nbsp; Add Customer </a>  
        ...
        <button class="btn btn-blue waves-effect waves-light"><i class="fa-regular fa-file-lines"></i> &nbsp; Create Invoice</button>
                ...
                <div class="tab-pane" id="settings">
                    ...
                    <tbody>
                        ...
                        <form method="post" action="{{ url('/add-cart') }}">
                            ...
                            <td>{{ $key+1 }}</td>
                            <td> <img src="{{ asset($item->product_image) }}" style="width:120px; height: 150px;"> </td>
