                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method = "post" action = "{{route('employee.store')}}" enctype = "multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name = "dept" class="form-control @error('dept') is-invalid @enderror ">
                                                                @error('dept')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="text-end">
                                                        <button type="submit" class="btn btn-success waves-effect waves-light mt-2"><i class="fa-solid fa-plus"></i>&nbsp; Add Employee </button>
                                                    </div>
                                                </form>
                                            </div>
