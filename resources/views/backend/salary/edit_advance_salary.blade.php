                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        ...
                                        <li class="breadcrumb-item"><a  class="btn btn-primary rounded-pill waves-effect waves-light text-light" href="{{ route('all.advance.salary') }}"><i class="fa-solid fa-angle-left"></i> &nbsp; Back </a></li>
...
<option value="December"{{ $salary->month == 'December' ? 'selected' : '' }}>December</option> 
 ...
 <div class="col-md-6">
      ...
      <span class="text-danger"> {{ $message }} </span>
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-success waves-effect waves-light mt-2"><i class="fa-solid fa-money-bill"></i> Update Advance </button>
            </div>
        </form>
    </div>
